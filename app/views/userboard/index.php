...
<head>
  ...
  <!-- 
    - preload images
  -->
  <link rel="preload" as="image" href="<?=FRONTASSET?>/assets/images/hero-slider-1.jpg">
  <link rel="preload" as="image" href="<?=FRONTASSET?>/assets/images/hero-slider-2.jpg">
  <link rel="preload" as="image" href="<?=FRONTASSET?>/assets/images/hero-slider-3.jpg">
...
<body id="top">
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <a href="#" class="logo">
        <img src="<?= FRONTASSET?>/assets/images/logo.svg" width="160" height="50" alt="Grilli - Home">
      </a>
    ...
    <article>
      ...
      <section class="hero text-center" aria-label="home" id="home">
        ...
        <ul class="hero-slider" data-hero-slider>
          ...
          <li class="slider-item active" data-hero-slider-item>
            ...
            <div class="slider-bg">
              <img src="<?= FRONTASSET?>/assets/images/hero-slider-1.jpg" width="1880" height="950" alt="" class="img-cover">
            </div>
          ...
          <li class="slider-item" data-hero-slider-item>
            ...
            <div class="slider-bg">
              <img src="<?= FRONTASSET?>/assets/images/hero-slider-2.jpg" width="1880" height="950" alt="" class="img-cover">
            </div>
          ...
          <li class="slider-item" data-hero-slider-item>
            ...
            <div class="slider-bg">
              <img src="<?= FRONTASSET?>/assets/images/hero-slider-3.jpg" width="1880" height="950" alt="" class="img-cover">
            </div>
      ...
      <section class="section service bg-black-10 text-center" aria-label="service">
        <div class="container">
          ...
          <ul class="grid-list">
              ...
              <div class="service-card">
                ...
                <a href="#" class="has-before hover:shine">
                  <figure class="card-banner img-holder" style="--width: 285; --height: 336;">
                    <img src="<?= FRONTASSET?>/assets/images/service-1.jpg" width="285" height="336" loading="lazy" alt="Breakfast"
                      class="img-cover">
                  </figure>
                </a>
            ...
            <li>
              <div class="service-card">
                ...
                <a href="#" class="has-before hover:shine">
                  <figure class="card-banner img-holder" style="--width: 285; --height: 336;">
                    <img src="<?= FRONTASSET?>/assets/images/service-2.jpg" width="285" height="336" loading="lazy" alt="Appetizers"
                      class="img-cover">
                  </figure>
                </a>
            ...
            <li>
              <div class="service-card">
                ...
                <a href="#" class="has-before hover:shine">
                  <figure class="card-banner img-holder" style="--width: 285; --height: 336;">
                    <img src="<?= FRONTASSET?>/assets/images/service-3.jpg" width="285" height="336" loading="lazy" alt="Drinks"
                      class="img-cover">
                  </figure>
                </a>
          ...
          <img src="<?= FRONTASSET?>/assets/images/shape-2.png" width="343" height="345" loading="lazy" alt="shape"
      ...
      <section class="section about text-center" aria-labelledby="about-label" id="about">
       ...
       <div class="container">
          ...
          <figure class="about-banner">
            ...
            <img src="<?= FRONTASSET?>/assets/images/about-banner.jpg" width="570" height="570" loading="lazy" alt="about banner"
              class="w-100" data-parallax-item data-parallax-speed="1">

            <div class="abs-img abs-img-1 has-before" data-parallax-item data-parallax-speed="1.75">
              <img src="<?= FRONTASSET?>/assets/images/about-abs-image.jpg" width="285" height="285" loading="lazy" alt=""
                class="w-100">
            </div>

            <div class="abs-img abs-img-2 has-before">
              <img src="<?= FRONTASSET?>/assets/images/badge-2.png" width="133" height="134" loading="lazy" alt="">
            </div>

          </figure>

          <img src="<?= FRONTASSET?>/assets/images/shape-3.png" width="197" height="194" loading="lazy" alt="" class="shape">
      ...
      <section class="special-dish text-center" aria-labelledby="dish-label">
        ...
        <div class="special-dish-banner">
          <img src="<?= FRONTASSET?>/assets/images/special-dish-banner.jpg" width="940" height="900" loading="lazy" alt="special dish"
            class="img-cover">
        </div>
        ...
        <div class="special-dish-content bg-black-10">
          <div class="container">
            ...
            <img src="<?= FRONTASSET?>/assets/images/badge-1.png" width="28" height="41" loading="lazy" alt="badge" class="abs-img">
        ...
        <img src="<?= FRONTASSET?>/assets/images/shape-4.png" width="179" height="359" loading="lazy" alt="" class="shape shape-1">

        <img src="<?= FRONTASSET?>/assets/images/shape-9.png" width="351" height="462" loading="lazy" alt="" class="shape shape-2">
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="<?= $menu['path']?>" width="100" height="100" loading="lazy" alt="Greek Salad"
                    class="img-cover">
                </figure>
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    <h3 class="title-3">
                      <a href="#" class="card-title"><?= $menu['title']?></a>
                    </h3>
      ...
      <section class="section testi text-center has-bg-image"
        ...
        <div class="container">
          ...
          <div class="profile">
            <img src="<?= FRONTASSET?>/assets/images/testi-avatar.jpg" width="100" height="100" loading="lazy" alt="Sam Jhonson"
              class="img">
      ...
      <section class="reservation">
        <div class="container">
          ...
          <div class="form reservation-form bg-black-10">
            ...
            <form action="postReservation" method="post" class="form-left">
      ...
      <section class="section features text-center" aria-label="features">
        <div class="container">
          ...
          <ul class="grid-list">
            ...
            <li class="feature-item">
              <div class="feature-card">
                ...
                <div class="card-icon">
                  <img src="<?= FRONTASSET?>/assets/images/features-icon-1.png" width="100" height="80" loading="lazy" alt="icon">
                </div>
            ...
            <li class="feature-item">
              <div class="feature-card">
                ...
                <div class="card-icon">
                  <img src="<?= FRONTASSET?>/assets/images/features-icon-2.png" width="100" height="80" loading="lazy" alt="icon">
                </div>
            ...
            <li class="feature-item">
              <div class="feature-card">
                ...
                <div class="card-icon">
                  <img src="<?= FRONTASSET?>/assets/images/features-icon-3.png" width="100" height="80" loading="lazy" alt="icon">
                </div>
            ...
            <li class="feature-item">
              <div class="feature-card">
                ...
                <div class="card-icon">
                  <img src="<?= FRONTASSET?>/assets/images/features-icon-4.png" width="100" height="80" loading="lazy" alt="icon">
                </div>
          ...
          <img src="<?= FRONTASSET?>/assets/images/shape-8.png" width="120" height="115" loading="lazy" alt="shape"
            class="shape shape-2">
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="event-card has-before hover:shine">
                ...
                <div class="card-banner img-holder" style="--width: 350; --height: 450;">
                  <img src="<?= FRONTASSET?>/assets/images/event-1.jpg" width="350" height="450" loading="lazy"
            ...
            <li>
              <div class="event-card has-before hover:shine">
                ...
                <div class="card-banner img-holder" style="--width: 350; --height: 450;">
                  <img src="<?= FRONTASSET?>/assets/images/event-2.jpg" width="350" height="450" loading="lazy"
                    alt="Flavour so good you’ll try to eat with your eyes." class="img-cover">
            ...
            <li>
              <div class="event-card has-before hover:shine">
                ...
                <div class="card-banner img-holder" style="--width: 350; --height: 450;">
                  <img src="<?= FRONTASSET?>/assets/images/event-3.jpg" width="350" height="450" loading="lazy"
                    alt="Flavour so good you’ll try to eat with your eyes." class="img-cover">
    ...
    <div class="container">
      ...
      <div class="footer-top grid-list">
        ...
        <div class="footer-brand has-before has-after">
          ...
          <a href="#" class="logo">
            <img src="<?= FRONTASSET?>/assets/images/logo.svg" width="160" height="50" loading="lazy" alt="grilli home">
          </a>
  ...
  <!-- 
    - custom js link
  -->
  <script src="<?= FRONTASSET?>/assets/js/script.js"></script>
